...
struct fence *sw_sync_fence_create(struct sw_sync_timeline *obj, u32 value)
{
	struct sw_sync_fence *pt;

	pt = (struct sw_sync_fence *)
		sync_pt_create(&obj->obj, sizeof(struct sw_sync_fence));
...
{
	struct sw_sync_fence *pt = (struct sw_sync_fence *)fence;
